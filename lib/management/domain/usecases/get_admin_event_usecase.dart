...
class GetAdminEventUseCase extends BaseUseCase<List<Event>,NoParameters>{
  final BaseManagementRepository baseManagementRepository;

  GetAdminEventUseCase(this.baseManagementRepository);

  @override
  Future<Either<Failure, List<Event>>> call(NoParameters parameters) async{
    return await baseManagementRepository.getAdminEvents();
  }
