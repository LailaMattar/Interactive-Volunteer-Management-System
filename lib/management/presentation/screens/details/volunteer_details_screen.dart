...
class VolunteerDetailsScreen extends StatefulWidget {
  VolunteerDetailsScreen({Key? key,required this.id}) : super(key: key);
  int id;
...
class _VolunteerDetailsScreenState extends State<VolunteerDetailsScreen> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    controller.getProfile(GetProfileParameters(id: widget.id));
    return Scaffold(
      appBar: MyAppBar.titledAppBar(title: 'تفاصيل المتطوع'),
      body: Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          controller.saveProfileImage(UploadProfileImageParameters(
                            ...
                            volunteerId: widget.id.toString(),
